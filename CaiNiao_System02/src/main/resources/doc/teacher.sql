...
INSERT INTO `tbl_dept` VALUES ('111', '殴打卤蛋', '7', '0', '0', '', null, '', null);
...
INSERT INTO `tbl_menu` VALUES ('102', '菜单管理', '1', '3', '/menu/toShowMenu2', 'C', '0', 'system:menu:view', '#', 'admin', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', '菜单管理菜单');
...
INSERT INTO `tbl_role` VALUES ('7', '卤蛋', 'ludan', '4', '1', '0', '', null, '', null, 'sad');
...
INSERT INTO `tbl_role_menu` VALUES ('7', '1');
INSERT INTO `tbl_role_menu` VALUES ('7', '100');
INSERT INTO `tbl_role_menu` VALUES ('12', '1');
INSERT INTO `tbl_role_menu` VALUES ('12', '100');
INSERT INTO `tbl_role_menu` VALUES ('12', '101');
INSERT INTO `tbl_role_menu` VALUES ('12', '1000');
INSERT INTO `tbl_role_menu` VALUES ('12', '1001');
...
CREATE TABLE `tbl_user` (
  ...
  `remark` varchar(500) DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1023 DEFAULT CHARSET=utf8 COMMENT='用户信息表';

-- ----------------------------
-- Records of tbl_user
-- ----------------------------
INSERT INTO `tbl_user` VALUES ('1', '101', 'admin', '郑浩铭', 'CaiNiao@qq.com', '11011011011', '男', null, '280111d7f4fa14ff76606fe1ffa4d782', '9ed6610c-6132-4d0c-a8a4-5011080ba754', '0', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2020-01-01 21:15:13', '管理员');
INSERT INTO `tbl_user` VALUES ('3', '101', 'admin1', '龙豪天', 'CaiNiao1@163.com', '11911911911', '男', null, 'f4a77e1417b03bf32d4b33a137282093', '4bd21f', '0', '0', 'admin', '2019-04-18 11:48:31', 'admin', '2019-08-07 12:31:29', '');
INSERT INTO `tbl_user` VALUES ('4', '101', 'admin2', '梁家豪', '86587432@qq.com', '12012012012', '男', null, '3512abbc9c7c8daa4c3560e79f8d1858', '568629be-6ca4-46eb-baaf-f6fea4c23d74', '0', '0', 'admin', '2019-08-07 15:46:18', 'admin', '2019-08-07 16:24:29', '');
INSERT INTO `tbl_user` VALUES ('5', '103', 'admin3', '梁俊杰', '7987954@qq.com', '12345678901', '男', null, '6d70551312e8167cb363020454a3ba03', 'f06b8d', '0', '0', 'admin', '2019-12-31 15:38:14', 'admin', '2020-01-01 21:02:55', '');
INSERT INTO `tbl_user` VALUES ('1000', '101', 'test1', '傻逼黄文杰', 'aaa1235646@126.com', '44444444444', '女', null, '3c6068239f1e807c6e10ec0762dcc56f', '4d275c0f-ac3b-40d7-82a2-e9aa866f1904', null, '0', '', null, '', null, '');
...
INSERT INTO `tbl_user_role` VALUES ('999', '1');
INSERT INTO `tbl_user_role` VALUES ('1000', '2');
INSERT INTO `tbl_user_role` VALUES ('1007', '1');
INSERT INTO `tbl_user_role` VALUES ('1008', '1');
INSERT INTO `tbl_user_role` VALUES ('1009', '1');
INSERT INTO `tbl_user_role` VALUES ('1010', '1');
INSERT INTO `tbl_user_role` VALUES ('1011', '1');
INSERT INTO `tbl_user_role` VALUES ('1012', '1');
INSERT INTO `tbl_user_role` VALUES ('1013', '1');
INSERT INTO `tbl_user_role` VALUES ('1014', '1');
INSERT INTO `tbl_user_role` VALUES ('1015', '1');
INSERT INTO `tbl_user_role` VALUES ('1016', '1');
INSERT INTO `tbl_user_role` VALUES ('1017', '1');
INSERT INTO `tbl_user_role` VALUES ('1018', '1');
INSERT INTO `tbl_user_role` VALUES ('1019', '1');
INSERT INTO `tbl_user_role` VALUES ('1020', '1');
INSERT INTO `tbl_user_role` VALUES ('1021', '1');
INSERT INTO `tbl_user_role` VALUES ('1022', '1');
INSERT INTO `tbl_user_role` VALUES ('1023', '1');
INSERT INTO `tbl_user_role` VALUES ('1024', '7');
