...
public class UserBizImpl implements UserBiz{
        ...
        @Override
        public int insertUserRoleId(User record){
            return userMapper.insertUserRoleId(record);
        }
        ...
        @Override
        public List<User> searchUserById(int userId){return userMapper.searchUserById(userId);}
        @Override
        public int updateUserRoleById(User record){return userMapper.updateUserRoleById(record);}
